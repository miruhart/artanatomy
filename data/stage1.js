...
const STAGE1_DATA = {
  ...
  subs: [
    ...
    // --- 5. からだ (mirror) ---
    {
      ...
      meaning: "指先の微細な形や角度は、表情以上にその人の本音や祈りを語る。サインやポーズの意味を解読する知的な面白さがある。",
      episodes: [
        {
          vol: "vol.12",
    ...
    },
    {
      ...
      meaning: "人を強く抱きしめるポーズは、愛情の深さと温もりを伝えるとともに、画面全体の優しい一体感を生み出す。",
      episodes: [
        {
          vol: "vol.10",
    ...
    },
    {
      ...
      tags: ["#ざわざわ", "#ハッとする", "#落ち着かない"],
      meaning: "描かれた人々が一斉に向ける目線につられて、鑑賞者もその先を探してしまう。誰かに見つめられているような緊張感を煽る。"
    },
    {
    ...
    },
    {
      ...
      meaning: "同じ形やパターンが幾重にも繰り返される仕掛け。視覚的なリズムを生むと同時に、脳の処理をフリーズさせる感覚を作る。",
      episodes: [
        {
          vol: "vol.31",
