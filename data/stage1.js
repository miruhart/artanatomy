// Stage1の中身：視覚のしかけカテゴリ・全サブ要素・感情マッピング・漫画30話連携（カラーswatch復元版）
const STAGE1_DATA = {
  categories: [
    {
      key: "color",
  ...
  emotions: [
    {
      ...
      subs: ["white", "blue", "sacredlight", "moonlight", "softlight", "hands", "embrace", "horizon", "silence", "gold", "silver"]
    },
    {
      ...
      subs: ["black", "chiaroscuro", "backlight", "hyperdetail", "center", "goldenratio", "depth", "ruins", "stillmotion", "beautyfear", "lifeanddeath", "gold"]
    },
    {
    ...
    },
    {
      ...
      subs: ["black", "darkness", "asymmetry", "pain", "facingaway", "silence", "deform", "beautyfear", "grid", "purple", "green"]
    },
    {
  ...
  subs: [
    ...
    {
      key: "purple", name: "紫", icon: "gem", cat: "color",
      swatch: "#8b5fbf",
      summary: "情熱と静寂が交ざる神秘の色",
      meaning: "動的な「赤」と静的な「青」という正反対の性格が混ざり合う色。交わるはずのない熱と冷たさが同居し、高貴で不穏な感情を漂わせる。"
    },
    {
      key: "gold", name: "金", icon: "crown", cat: "color",
      swatch: "linear-gradient(135deg,#f6e27a,#c9a227)",
      summary: "現実を消し去る黄金の異世界",
      meaning: "光を無数の角度へ跳ね返す金色の背景は、絵画本来の奥行きや距離感をリセットする。現実世界を消し去り、神聖な空間へいざなう。"
    },
    {
      key: "silver", name: "銀", icon: "shield-halved", cat: "color",
      swatch: "linear-gradient(135deg,#f2f2f2,#a8a8a8)",
      summary: "冴え渡る知性と冷たい輝き",
      meaning: "熱っぽさを排した金属的な輝き。未来的で凛とした気品を感じさせる一方で、血の通った温もりを遮断した冷酷な静寂を醸し出す。"
    },
    {
      key: "warmcool", name: "暖色・寒色", icon: "temperature-half", cat: "color",
      swatch: "linear-gradient(135deg,#e5484d,#3b6fd4)",
    ...
    },
    {
      ...
      swatch: "linear-gradient(135deg,#e5484d,#4caf6a)",
    ...
    },
    {
      ...
      swatch: "linear-gradient(135deg,#3b6fd4,#ff8a3d)",
